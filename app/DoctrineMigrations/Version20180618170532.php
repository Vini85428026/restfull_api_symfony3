 ...
 */
class Version20180618170532 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE role CHANGE person_id person_id INT DEFAULT NULL, CHANGE movie_id movie_id INT DEFAULT NULL');
    }
